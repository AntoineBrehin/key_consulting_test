...
public class TaskService {
    ...
    public void init() {
        ...
        tasksList.add(new Task("uuid-example-1", "Sortir Médor", "Sortir l'animal de la famille des canidés afin de générer du bonheur", false));
        ...
        tasksList.add(new Task("uuid-example-4", "Préparer la soirée JDR", "Ecrire une campagne de jeu de rôle correcte qu'aucun joueur ne suivra de toute façon", false));
